...
const DotGrid: React.FC<DotGridProps> = ({
  ...
  const buildGrid = useCallback(() => {
    ...
    // 🔹 Ajuste clave: evitar redondeos inconsistentes
  ...
  return (
    <section
    className={`tw-absolute tw-inset-0 tw-flex tw-items-center tw-justify-center tw-h-full tw-w-full tw-overflow-hidden tw-pointer-events-none `}
    >
